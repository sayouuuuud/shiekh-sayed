...
import { Bell, User, LogOut, Settings, Check, Globe } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className={`text-sm font-medium text-muted-foreground ${locale === "en" ? "font-arabic" : ""}`}>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className={`w-80 ${isRTL ? "font-arabic" : ""}`}>
