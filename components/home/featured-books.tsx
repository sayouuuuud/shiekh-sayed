    ...
    <section className="py-16 bg-surface dark:bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-end mb-12">
          <div>
            <span className="text-xs font-bold text-primary bg-green-50 dark:bg-green-900/30 px-3 py-1 rounded-full mb-3 inline-block">
              المكتبة العلمية
            </span>
            <h2 className="text-4xl font-bold font-serif dark:text-white">مؤلفات الشيخ المختارة</h2>
          </div>
          <Link
            href="/books"
            className="hidden sm:flex items-center gap-2 text-text-muted dark:text-text-subtext hover:text-primary dark:hover:text-primary transition bg-background dark:bg-background-alt px-4 py-2 rounded-lg text-sm"
          >
            عرض كل المؤلفات
              ...
              return (
                <div key={book.id} className="group">
                  ...
                  <div className="bg-background dark:bg-background-alt p-6 rounded-b-2xl border-t border-border dark:border-border">
                    <Link href={`/books/${book.id}`}>
                      <h3 className="font-bold text-lg mb-2 dark:text-white group-hover:text-primary transition cursor-pointer">
                        {book.title}
                      </h3>
                    </Link>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs bg-border dark:bg-border-light px-2 py-1 rounded text-text-muted dark:text-text-subtext">
